...
LINEAR_INCREMENT = 0.25  # Increment for linear velocity (m/s)
ANGULAR_INCREMENT = 1.25  # Increment for angular velocity (rad/s)

# Velocity limits
LINEAR_MAX = 0.5  # Maximum linear velocity (m/s)
LINEAR_MIN = -LINEAR_MAX # Minimum linear velocity (m/s)
ANGULAR_MAX = 3.75  # Maximum angular velocity (rad/s)
