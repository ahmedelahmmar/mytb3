...
class MLPNavigator:
    ...
    def load_models(self):
        ...
        try:
            self.model = joblib.load('/home/ahmar/docs/prj/mytb3/mytb3_ws/src/mytb3_nav/models/mlp_model_sklearn_yolo.pkl')
            self.scaler = joblib.load('/home/ahmar/docs/prj/mytb3/mytb3_ws/src/mytb3_nav/models/mlp_scaler_yolo.pkl')
