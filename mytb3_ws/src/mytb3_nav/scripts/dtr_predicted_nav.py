...
model = joblib.load('/home/ahmar/docs/prj/mytb3/mytb3_ws/src/mytb3_nav/models/decision_tree_model.pkl')
scaler_X = joblib.load('/home/ahmar/docs/prj/mytb3/mytb3_ws/src/mytb3_nav/models/scaler_X_dtr.pkl')
scaler_y = joblib.load('/home/ahmar/docs/prj/mytb3/mytb3_ws/src/mytb3_nav/models/scaler_y_dtr.pkl')
...
def calculate_error_and_predict():
    ...
    # Inverse transform the predicted velocities to get them in the original scale
    # output = scaler_y.inverse_transform(output_scaled)
    
    # Extract linear and angular velocities from the scaled output
