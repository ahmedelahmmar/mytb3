...
# Load the trained RandomForestRegressor model and scaler
model = joblib.load('/home/ahmar/docs/prj/mytb3/mytb3_ws/src/mytb3_nav/models/rf_model.pkl')  # Load the Random Forest model
scaler = joblib.load('/home/ahmar/docs/prj/mytb3/mytb3_ws/src/mytb3_nav/models/rf_scaler.pkl')  # Load the scaler
...
def calculate_error_and_predict():
    ...
    # Make the prediction using the trained model (Random Forest)
